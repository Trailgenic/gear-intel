import { closePool, withTransaction } from '../src/db/client.js';
import { seedProducts } from '../src/seed/catalog.js';
import { rubrics, validateRubrics } from '../src/rubrics/index.js';
...
async function main() {
  ...
  console.log(`Seeded ${Object.keys(rubrics).length} rubrics and ${seedProducts.length} legacy-unverified product candidates.`);
}
